...
class RentBook extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            let res = await fetch(apiPath + "/api/book/rent", {
                method: "POST",
                body: formBody,
                headers: {
                ...
                return(
                    <div>
                        <Card bg='success' className="col-md-5 mx-auto text-center">
                            <Card.Body>Libro affittato con successo</Card.Body>
                        </Card>
                    </div>
                );
            case false:
                ...
                return (
                    <div>
                        <Card className="text-center">
                            <Card.Body>Inserisci l'isbn del libro che vuoi affittare</Card.Body>
                        </Card>
                        <Form>
